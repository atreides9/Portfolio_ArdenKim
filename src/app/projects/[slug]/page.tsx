...
import { ArrowLeft, Calendar, Hash, Tag } from 'lucide-react';
                      ...
                      <>
                        ...
                        <div id="design" className="pt-8">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                            ...
                            스타벅스의 브랜드 아이덴티티를 유지하면서도 현대적이고 직관적인 사용자
                            경험을 제공하는 것이 목표였습니다.
                          </p>
                        </div>
                        ...
                        <div id="solution" className="pt-8">
                          ...
                          <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                            개인화된 대시보드와 원터치 재주문 시스템으로 사용자의 주문 시간을 대폭
                            단축했습니다. 카테고리별 메뉴 재구성으로 탐색 효율성을 크게
                            개선했습니다.
                          </p>
                        </div>
