...
export const AI_PROJECTS: AiProject[] = [
  {
    ...
    description: '디자인 파일을 실제 작동하는 코드로 자동 변환. Claude 3.5 Sonnet의 비전 API를 활용해 Figma 디자인을 React 컴포넌트로 95% 정확도로 변환합니다.',
    status: 'live',
    category: 'automation',
    icon: '⚡',
  ...
  },
  {
    ...
    description: '사용자 인터뷰 데이터를 AI로 분석해 페르소나와 여정지도를 자동 생성. 50시간의 분석 작업을 20분으로 단축시키는 도구입니다.',
    status: 'beta',
    category: 'research',
    icon: '🔍',
  ...
  },
  {
    ...
    description: '혼자서도 스타트업을 런칭할 수 있는 AI 도구 모음. 아이디어 검증부터 MVP 제작, 마케팅까지 전 과정을 AI와 함께 진행합니다.',
    status: 'coming-soon',
